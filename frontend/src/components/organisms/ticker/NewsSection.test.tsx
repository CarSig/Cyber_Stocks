...
beforeEach(() => {
  vi.spyOn(useNewsAnalysisModule, 'useNewsAnalysis').mockReturnValue(
    makeHook() as unknown as ReturnType<typeof useNewsAnalysisModule.useNewsAnalysis>,
  );
});
...
describe('NewsSection', () => {
  ...
  it('shows Queuing… while mutation is pending', () => {
    vi.spyOn(useNewsAnalysisModule, 'useNewsAnalysis').mockReturnValue(
      makeHook({ analyze: { mutate: vi.fn(), isPending: true, data: null } }) as unknown as ReturnType<
        typeof useNewsAnalysisModule.useNewsAnalysis
      >,
    );
    render(<NewsSection ticker="CRWD" news={ARTICLES} />);
  ...
  it('shows Processing… and disables button while polling', () => {
    vi.spyOn(useNewsAnalysisModule, 'useNewsAnalysis').mockReturnValue(
      makeHook({ polling: true, analyze: { mutate: vi.fn(), isPending: false, data: null } }) as unknown as ReturnType<
        typeof useNewsAnalysisModule.useNewsAnalysis
      >,
    );
    render(<NewsSection ticker="CRWD" news={ARTICLES} />);
  ...
  it('shows "All articles already analyzed" when queued is 0', () => {
    vi.spyOn(useNewsAnalysisModule, 'useNewsAnalysis').mockReturnValue(
      makeHook({
        analyze: { mutate: vi.fn(), isPending: false, data: { queued: 0, total: 5 } },
  ...
  it('shows queued count when articles were enqueued', () => {
    vi.spyOn(useNewsAnalysisModule, 'useNewsAnalysis').mockReturnValue(
      makeHook({
        analyze: { mutate: vi.fn(), isPending: false, data: { queued: 12, total: 20 } },
      }) as unknown as ReturnType<typeof useNewsAnalysisModule.useNewsAnalysis>,
    );
    render(<NewsSection ticker="CRWD" news={ARTICLES} />);
  ...
  it('calls analyze.mutate when button is clicked', () => {
    const mutate = vi.fn();
    vi.spyOn(useNewsAnalysisModule, 'useNewsAnalysis').mockReturnValue(
      makeHook({ analyze: { mutate, isPending: false, data: null } }) as unknown as ReturnType<
        typeof useNewsAnalysisModule.useNewsAnalysis
      >,
    );
    render(<NewsSection ticker="CRWD" news={ARTICLES} />);
  ...
  it('calls setShowCorrelation when Correlation button is clicked', () => {
    ...
    vi.spyOn(useNewsAnalysisModule, 'useNewsAnalysis').mockReturnValue(
      makeHook({ setShowCorrelation }) as unknown as ReturnType<typeof useNewsAnalysisModule.useNewsAnalysis>,
    );
    render(<NewsSection ticker="CRWD" news={ARTICLES} />);
  ...
  it('renders correlation loading state', () => {
    vi.spyOn(useNewsAnalysisModule, 'useNewsAnalysis').mockReturnValue(
      makeHook({
        ...
        correlation: { isPending: true, data: null, error: null },
      }) as unknown as ReturnType<typeof useNewsAnalysisModule.useNewsAnalysis>,
    );
    render(<NewsSection ticker="CRWD" news={ARTICLES} />);
  ...
  it('renders sentiment badges when analysis data is present', () => {
    vi.spyOn(useNewsAnalysisModule, 'useNewsAnalysis').mockReturnValue(
      makeHook({ analysis: { data: ANALYSIS_DATA } }) as unknown as ReturnType<
        typeof useNewsAnalysisModule.useNewsAnalysis
      >,
    );
    render(<NewsSection ticker="CRWD" news={ARTICLES} />);
  ...
  it('shows analyzed count when analysis data is present', () => {
    vi.spyOn(useNewsAnalysisModule, 'useNewsAnalysis').mockReturnValue(
      makeHook({ analysis: { data: ANALYSIS_DATA }, analyzedCount: 2 }) as unknown as ReturnType<
        typeof useNewsAnalysisModule.useNewsAnalysis
      >,
    );
    render(<NewsSection ticker="CRWD" news={ARTICLES} />);
  ...
  it('shows 0 analyzed when no analysis data', () => {
    vi.spyOn(useNewsAnalysisModule, 'useNewsAnalysis').mockReturnValue(
      makeHook({ analyzedCount: 0 }) as unknown as ReturnType<typeof useNewsAnalysisModule.useNewsAnalysis>,
    );
    render(<NewsSection ticker="CRWD" news={ARTICLES} />);
