...
import * as useNewsAnalysisModule from '../../hooks/useNewsAnalysis.js';

vi.mock('../../hooks/useNewsAnalysis.js');
...
beforeEach(() => {
  vi.spyOn(useNewsAnalysisModule, 'useNewsAnalysis').mockReturnValue(makeHook());
});
...
describe('NewsSection', () => {
  ...
  it('renders 0 articles gracefully when news is undefined', () => {
    render(<NewsSection ticker="CRWD" news={undefined} />);
    expect(screen.getByText(/0 articles/i)).toBeInTheDocument();
  });
