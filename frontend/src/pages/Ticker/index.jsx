...
function TickerContent() {
  ...
  // Transform cyber news articles to format expected by NewsChart
          ...
          <div className="ticker-main">
            ...
            {activeTab === 'charts' && (
              <ChartsTab
                ...
                setCompareTicker={setCompareTicker}
                ...
                hideVolatility={hideVolatility}
                setHideVolatility={setHideVolatility}
                hideNewsSentiment={hideNewsSentiment}
                setHideNewsSentiment={setHideNewsSentiment}
                hideIntelligence={hideIntelligence}
                setHideIntelligence={setHideIntelligence}
                hideCyberNewsSentiment={hideCyberNewsSentiment}
                setHideCyberNewsSentiment={setHideCyberNewsSentiment}
                overlays={overlays}
                intelligenceArticles={intelligenceArticles.data}
                entityId={entityId}
            ...
            {activeTab === 'correlations' && (
              <CorrelationsTab
                ...
                correlagDays={correlagDays}
                setCorrelagDays={setCorrelagDays}
                trump={trump}
