    ...
    <div className="graph-detail-panel">
      <div className="graph-detail-header">
        ...
        <div className="graph-detail-badges">
          <Badge variant="outline" className="graph-badge-route">{node.route}</Badge>
        ...
        <>
          ...
          <section className="graph-detail-section">
            ...
            <ul className="graph-detail-list">
              {node.apis.map((api) => (
                <li key={api} className="graph-detail-api">{api}</li>
              ))}
            </ul>
          </section>
        </>
          ...
          <section className="graph-detail-section">
            ...
            <ul className="graph-detail-list">
              {node.dataFlows.map((df) => (
                <li key={df} className="graph-detail-flow">{DATA_FLOW_LABELS[df] ?? df}</li>
              ))}
            </ul>
          </section>
        </>
